...
public class SearchClient
{
    ...
    /// </summary>
    public async Task<PagedBatch<VideoSearchResult>> GetVideosPagedBatchAsync(
        string searchQuery,
    ...
    )
    {
        ...
        {
            var videoId =
                videoData.Id ?? throw new YoutubeExplodeException("Could not extract video ID.");
        ...
        return PagedBatch.Create(results, searchResults.ContinuationToken);
    }
